...
Use the included bootstrapped `run_archive.Rdata` and `rat_archive.csv`. However, WARNING: you need to delete the bootstrapped data from run_archive. If you don't, then on trying to import this old data these runs will get skipped and their corrensponding trial data won't get added to the trial archives. 
